...
// 비동기 함수를 한 번만 실행하고 결과를 캐시하는 헬퍼 함수
...
// 각각의 데이터를 캐시된 함수로 감싸도록 함
const cachedFetchers = [
  createCachedFetch(fetchMajors, "1"),
  createCachedFetch(fetchLiberalArts, "2"),
  createCachedFetch(fetchMajors, "3"),
  createCachedFetch(fetchLiberalArts, "4"),
  createCachedFetch(fetchMajors, "5"),
  createCachedFetch(fetchLiberalArts, "6"),
];
