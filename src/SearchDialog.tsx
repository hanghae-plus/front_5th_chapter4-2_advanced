...
const fetchAllLectures = async (): Promise<Lecture[]> => {
  ...
  fetchPromise = (async () => {
    ...
    try {
      ...
      console.log("API 호출에 걸린 시간(ms): ", performance.now() - start);

      lecturesCache = results.flatMap((res) => res.data);
      return lecturesCache;
    } catch (error) {
...
const SearchDialog = ({ searchInfo, onClose }: Props) => {
  ...
  // 검색 옵션 변경 함수를 useCallback으로 최적화
